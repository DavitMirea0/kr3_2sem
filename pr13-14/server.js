...
const vapidKeys = {
  publicKey: 'BLEDNhUV-3zL6U1UJqc_rOB1-E2VN5WK56QUoQejrmF2kxXmUWB3yuqtRZqf9uTar298p1xve4E_zAn3mwxwImE',
  privateKey: 'heLimK1d7Galfg2uiVXDYOnP7IPAZBH-tglHpw4jqtQ'
};
...
app.post('/snooze', (req, res) => {
  ...
  console.log('Snoozed', reminderId, 'for 5 min');
